...
function calcs.initModDB(env, modDB)
	...
	modDB:NewMod("DodgeRollDistance", "BASE", 4.5, "Base")
	modDB:NewMod("DodgeRollsPerSecond", "BASE", 1, "Base")
	modDB:NewMod("MonsterPower", "BASE", 20, "Base") -- Power of a Unique enemy
